<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.teachers.index') }}" class="text-sm text-gray-600 hover:text-gray-900 underline">
                ← Back
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-10 max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('admin.teachers.store') }}"
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Teacher name"
       ...
       dark:bg-white dark:text-gray-900"
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="teacher@example.com"
                        class="w-full border-gray-300 rounded-xl px-4 py-2
       bg-white text-gray-900
       dark:bg-white dark:text-gray-900"
                        @error('email')
